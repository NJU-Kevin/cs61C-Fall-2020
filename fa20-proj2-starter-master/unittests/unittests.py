...
class TestArgmax(TestCase):
    def test_simple(self):
        ...
        # create an array in the data section
        array0 = t.array([1, 2, 3, 4, 5, 5, 3, 4, 1, 2])
        # TODO
...
class TestMatmul(TestCase):
    ...
    def test_invalid_dimension_1(self):
        self.do_matmul([1, 2, 3, 4, 5, 6, 7, 8, 9], -1, 3,
            [1, 2, 3, 4, 5, 6, 7, 8, 9], 3, 3,
            [30, 36, 42, 66, 81, 96, 102, 126, 150] , code=72)
        
    def test_invalid_dimension_2(self):
        self.do_matmul([1, 2, 3, 4, 5, 6, 7, 8, 9], 3, 3,
            [1, 2, 3, 4, 5, 6, 7, 8, 9], 3, -1,
            [30, 36, 42, 66, 81, 96, 102, 126, 150] , code=73)
        
    def test_dismatch(self):
        self.do_matmul([1, 2, 3, 4, 5, 6, 7, 8, 9], 3, 2,
            [1, 2, 3, 4, 5, 6, 7, 8, 9], 3, 3,
            [30, 36, 42, 66, 81, 96, 102, 126, 150] , code=74)
        
    def test_nonsquare(self):
        self.do_matmul([1, 2], 1, 2, [2, 1], 2, 1, [4])

    def test_single_element(self):
        self.do_matmul([1], 1, 1, [4], 1, 1, [4])
...
class TestReadMatrix(TestCase):
    ...
    def test_fopen_fails(self):
        self.do_read_matrix('fopen', 90)

    def test_fclose_fails(self):
        self.do_read_matrix('fclose', 92)

    def test_fread_fails(self):
...
class TestClassify(TestCase):
    ...
    def test_argc_error(self):
        ...
        t.call("classify")
        t.execute(args=["only_one_arg"], code=89)

    def test_malloc_error(self):
        t = self.make_test()
        out_file = "outputs/test_basic_main/student5.bin"
        args = ["inputs/simple0/bin/m0.bin", "inputs/simple0/bin/m1.bin",
                "inputs/simple0/bin/inputs/input0.bin", out_file]
        t.call("classify")
        t.execute(fail='malloc', args=args, code=88)
